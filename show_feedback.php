...
<body>
    ...
    echo '<div class="tabletext"><h2>' . ": Feeback : " . '</h2></div>';
    ...
    <div class="table-container">
        <table border='3'>
            ...
            $query = "SELECT * from cust_feedback";
            ...
            while ($r = mysqli_fetch_array($result)) {
                ...
                echo "<tr>
                    <td>" . $r["id"] . "</td> 
                    <td>" . $r["user_name"] . "</td> 
                    <td>" . $r["title_details"] . "</td>
                    <td>" . $r["description_details"] . "</td> 
                    <td>" . $r["additional_details"] . "</td>   
                    <td><a href='admin_deleteFeedback.php?FID={$unique_id}'>DELETE RIDE</a></td> 
                    </tr>";
            }
            ?>
        </table>
